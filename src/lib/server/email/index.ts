...
// Settings saved in the DB. Holds settings for every provider, and `provider` switches which one is currently selected
...
// Prefer the DB configuration (/settings/email); fall back to environment variables when not configured
